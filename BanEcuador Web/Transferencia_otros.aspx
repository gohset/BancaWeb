<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site2.Master" CodeBehind="Transferencia_otros.aspx.vb" Inherits="BanEcuador_Web.Transferencia_otros" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="Panel1" runat="server" BackImageUrl="Imagenes/formulario1.png" 
        ...
        <asp:Label ID="Label18" runat="server" Font-Bold="True" Font-Size="XX-Large" 
            ForeColor="White" 
            Text="Transferencia a otras instituciones"></asp:Label>
        <br />
        <br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
