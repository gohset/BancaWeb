...
Public Class Provincia
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        DataGridView1.ForeColor = Drawing.Color.White
    ...
    Sub generar_nuevo()
        ...
        Dim otabla As New DataTable
        Try
            consulta = "SELECT MAX(codigo) FROM tb_provincia"
    ...
    Sub guardar_provincia()
        ...
        Else
            ...
            Try
                ...
                Dim cmd As New SqlCommand("INSERT INTO tb_provincia VALUES(@codigo,@provincia)", conexion)
    ...
    Sub editar_provincia()
        ...
        End If
        Try
            Dim cmd As New SqlCommand("UPDATE tb_provincia SET provincia='" & UCase(txtnombre_p.Text) & "' WHERE codigo=" & txtcodigo_p.Text & "", conexion)
            cmd.ExecuteNonQuery()
    ...
    Sub eliminar_provincia()
        ...
        If respuesta = vbYes Then
            ' eliminar()
            Dim cmd As New SqlCommand("DELETE  FROM tb_provincia WHERE codigo=" & txtcodigo_p.Text & "", conexion)
            cmd.ExecuteNonQuery()
